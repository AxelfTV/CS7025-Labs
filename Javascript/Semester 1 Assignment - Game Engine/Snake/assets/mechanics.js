...
function start() {
  ...
  if (highscore == null)
    window.localStorage.setItem("highscore", "0" + snakeLength.toString());
  updateHighscore();
  //Spawn Game Entities
  let head = new SnakeHead(
    20,
    "assets/sprites/snakeHeadUp.png",
    "0",
    START_X,
    START_Y,
    10
...
function spawnNewSnakeSegment() {
  ...
  let body = new SnakeBody(
    20,
    "assets/sprites/snakeBodyVertical.png",
    newId,
    0,
    0,
    10
...
function updateHighscore() {
  ...
  text.innerText =
    "Current Score: " + snakeLengthText + " Highscore: " + highscore;
  ...
  findPosition() {
    ...
    for (let e in entities) {
      if (entities[e].segmentNo == this.segmentNo - 1) {
        ...
        nextPosX = entities[e].gridX;
        nextPosY = entities[e].gridY;
      }
    }
    ...
    if (nextDifX == 0 && prevDifX == 0)
      this.setIdle(jsonData.snakeBodyVertical);
    else if (nextDifY == 0 && prevDifY == 0)
      this.setIdle(jsonData.snakeBodyHorizontal);
    else if (nextDifY == 1 && prevDifX == 1)
      this.setIdle(jsonData.snakeBodyCornerDownLeft);
    else if (nextDifY == 1 && prevDifX == -1)
      this.setIdle(jsonData.snakeBodyCornerDownRight);
    else if (nextDifY == -1 && prevDifX == 1)
      this.setIdle(jsonData.snakeBodyCornerUpLeft);
    else if (nextDifY == -1 && prevDifX == -1)
      this.setIdle(jsonData.snakeBodyCornerUpRight);
    else if (nextDifX == 1 && prevDifY == 1)
      this.setIdle(jsonData.snakeBodyCornerUpRight);
    else if (nextDifX == 1 && prevDifY == -1)
      this.setIdle(jsonData.snakeBodyCornerDownRight);
    else if (nextDifX == -1 && prevDifY == 1)
...
class PickUp extends Entity {
  ...
  constructor(x, y) {
    super(
      20,
      "assets/sprites/pickUpAnimations/apple1.png",
      "p",
      x * 20,
      y * 20
    );
